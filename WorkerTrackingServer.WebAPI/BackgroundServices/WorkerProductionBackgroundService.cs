...
public class WorkerProductionBackgroundService(
    ...
    IProductionCalculateService productionCalculateService,
    IUnitOfWork unitOfWork)
{
    ...
    public async Task WorkerProductionWeekly(CancellationToken cancellationToken)
    {
        await productionCalculateService.WeeklyProductionCalculate(cancellationToken);
